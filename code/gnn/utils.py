...
from dgllife.utils import smiles_to_bigraph, ScaffoldSplitter, RandomSplitter, mol_to_bigraph, ConsecutiveSplitter
...
def split_dataset(args, dataset):
    ...
    if args['split'] == 'scaffold_decompose':
        ...
        train_set = ConsecutiveSplitter.k_fold_split(
            dataset, k=10, log=True)
        val_set, test_set = [], []
    else:
